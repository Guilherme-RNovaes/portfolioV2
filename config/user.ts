...
const userProps: User =
{
  ...
  about: `Olá! Sou Guilherme Rogério Novaes, um desenvolvedor fullstack de ${userAge} anos, apaixonado por criar soluções digitais sob medida para transformar ideias em realidade. Com mais de três anos de experiência no universo da programação, especializei-me em JavaScript e React, dominando tanto o front-end quanto o back-end de aplicações web. Atualmente, trabalho como desenvolvedor autônomo, oferecendo serviços de criação de Landing Pages, E-commerces e Páginas Institucionais que combinam funcionalidade, estética e performance.`,
